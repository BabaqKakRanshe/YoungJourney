...
MESSAGE_TO_ANGEL = [
    "Твой подопечный оставил тебе сообщение: \n{text} ✨",
    "Твоя тайная звезда отправляет тебе пожелание: \n{text} 🌟",
    "Вот что твой подопечный хочет тебе передать: \n{text} 💬",
    "Твой подопечный готов удивить тебя: \n{text} 📜",
    "Вот что твой подопечный приготовил для тебя: \n{text} 📨",
    "Привет, это сообщение от твоего подопечного: \n{text} 💌",
    "Тайна от твоего подопечного: \n{text} 🤫",
    "Вот что тебе пишет подопечный: \n{text} 🎤",
    "Сообщение от твоего подопечного, которое ты ждал: \n{text} 📢",
    "Твой подопечный открыл секрет: \n{text} 🌈",
    "Вот, что тебе оставил твой подопечный: \n{text} 🤩",
    "Сообщение от подопечного, которое стоит запомнить: \n{text} 📝",
    "Подопечный делится с тобой важной информацией: \n{text} 💡"
]
